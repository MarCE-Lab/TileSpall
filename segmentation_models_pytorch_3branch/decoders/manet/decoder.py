...
class MAnetDecoder(nn.Module):
    def __init__(
        ...
        blocks_1[f"x_{0}_{len(self.in_channels)-1}"] = DecoderBlock(
            self.in_channels[-1], 0, self.out_channels[-1],kernel_size=3,dilation = 1, attention_types=attention_types, **kwargs
        )
        ...
        blocks_3[f"x_{0}_{len(self.in_channels)-1}"] = DecoderBlock(
            self.in_channels[-1], 0, self.out_channels[-1],kernel_size=3,dilation = 4, attention_types=attention_types, **kwargs
        )
        ...
        blocks_7[f"x_{0}_{len(self.in_channels)-1}"] = DecoderBlock(
            self.in_channels[-1], 0, self.out_channels[-1],kernel_size=3,dilation = 8, attention_types=attention_types, **kwargs
        )
